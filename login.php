            ...
            <div class="col">
              <div class="card">
                <div class="container-fluid">
                  ...
                  <div class="row">
                    <div class="col text-center">
                      <img src="dist/img/RQ.png" alt="AdminLTE Logo" class="text-center brand-image img-circle elevation-3" style="opacity: .8; width:100px;">  
                    </div>
                  </div>
                </div>
                <form action="code.php" method="POST">
                  <div class="card-body">
                    <div class="container-fluid">
                      ...
                      <div class="row">
                        <div class="col form-group">
                          <button class="btn btn-dark form-control">Sign In</button>
                        </div>
                      </div>
                      <p class="text-center">OR</p>
                      <div class="row">
                        <div class="col form-group">
                          <a href="register.php" class="btn btn-secondary form-control">Sign Up</a>
                        </div>
                      </div>
                    </div>
                  </div>
