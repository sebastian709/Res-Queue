...
<div class="">
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col bg-dark">
        <a href="logout.php" class="btn btn-secondary float-right mt-5">Home</a>
      </div>
    </div>
  </div>
  <div class="container-fluid">
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col mt-4 ml-5">
                <a href="main-selecttype.php" class="btn btn-secondary"><i class="fas fa-chevron-left"></i> Select Again</a>  
              </div>
              <div class="col">
                <h4 class="text-center header-title mt-4">List of Company</h4>
                <p class="text-center text-danger">(<?php echo $selecttype; ?>)</p>  
              </div>
              <div class="col">
            ...
            <table id="example" class="table table-striped table-bordered" style="width:100%">
              ...
              <tbody>
                <?php
                                                ...
                                                $table = mysqli_query($conn,'SELECT * FROM tbl_register WHERE type="'.$selecttype.'" ');
                  ...
                  <td>
                    <ul class="d-flex justify-content-center text-center">
                      <form action="code.php" method="POST">
                        <input type="hidden" name="getanoid" value="<?php echo $row["id"]; ?>">
                        <input type="hidden" name="getanotype" value="<?php echo $row["type"]; ?>">
                        <button class="mr-3 btn btn-success" name="getano" type="submit">Get a number <i class="fas fa-chevron-right"></i></button>
                      </form>  
                    </ul>
                  </td>
                </tr>
