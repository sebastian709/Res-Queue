...
<?php
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="company-dashboard.php" class="nav-link">
  ...
  <div class="content-wrapper">
    ...
    <?php
                                                ...
                                                $table = mysqli_query($conn,'SELECT * FROM tbl_register WHERE id="'.$_SESSION['ID'].'" ');
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col mb-5">
          <h4 class="text-center"><?php echo $row["companyname"]; ?></h4>  
        </div>
      </div>
      ...
      <div class="row">
        <div class="col form-group">
          ...
          <input class="form-control" value="<?php echo $row["companyname"]; ?>" name="ecname">
        </div>
        <div class="col form-group">
          <label>Abreviation_Branch</label>
          <input class="form-control" value="<?php echo $row["abv"]; ?>" name="eabv">
        </div>
      </div>
      ...
      <div class="row">
        <div class="col form-group">
                          <label>Type:</label>
                          <select class="form-control" name="ectype" value="<?php echo $row["type"]; ?>">
                                                            <option class="bg-dark text-white" value="<?php echo $row["type"]; ?>"  selected><?php echo $row["type"]; ?></option>  
        ...
        <div class="col form-group">
          <label>Email</label>
          <input class="form-control" value="<?php echo $row["email"]; ?>" name="eemail">
        </div>
        <div class="col form-group">
          <label>Contact</label>
          <input class="form-control" value="<?php echo $row["contact"]; ?>" name="econtact">
        </div>
      </div>
      ...
      <div class="row">
        <div class="col form-group">
          <label>Address</label>
          <input class="form-control" value="<?php echo $row["address"]; ?>" name="eadd">
        </div>
      </div>

      <div class="row">
        <div class="col form-group mt-4">
          <button class="form-control btn btn-primary" name="accupdate">Update</button>
        </div>
      </div>
    </div>
    <!-- /.content -->
