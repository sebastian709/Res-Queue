  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Aproved Company Account</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col  mt-5 ml-3">
          <a href="admin-comacc.php" class="btn btn-danger">Back</a>
        </div>
      </div>
    </div>
    <!-- /.content-header -->
            ...
            <table id="example" class="table table-striped table-bordered" style="width:100%">
              ...
              <tbody>
                <?php
                                                ...
                                                $table = mysqli_query($conn,'SELECT * FROM tbl_register WHERE status="Approved" ');
