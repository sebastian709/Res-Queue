...
<div class="">
    ...
    <div class="row">
      <div class="col-sm-3 bg-secondary">
        ...
        $conn = mysqli_connect($sname, $uname, $password, $db_name);
           ...
           $table = mysqli_query($conn,"SELECT * FROM schoolform");
               ...
               { 
                   ...
                   while ($row = mysqli_fetch_assoc($table)) 
                          {  
                                  ...
                                  ?>  
        <h4 class="bg-dark mt-1 text-center"></h4>
      ...
      <div class="col-sm-2 bg-dark">
        <h4 class="bg-danger mt-1 text-center font-weight-bold pointer-hand"><a href="company-dashboard.php">Back</a></h4>
      </div>
    </div>
  ...
  <?php
               ...
               { 
                   ...
                   while ($row = mysqli_fetch_assoc($table)) 
                          {  
                                  ...
                                  ?> 
                    <h1 class="display-1 font-weight-bold"><?php echo $row['current']; ?></h1> 
        ...
        <div class="container">
          <div class="row">
            <div class="col text-center mt-5 bg-dark mb-5">
