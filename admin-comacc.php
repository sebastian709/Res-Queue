...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Approved Company Account</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col  mt-5 ml-3">
          <a href="listofcomacc.php" class="btn btn-info">Approved Accounts</a>
        </div>
      </div>
    </div>
    <!-- /.content-header -->
            ...
            <table id="example" class="table table-striped table-bordered" style="width:100%">
              ...
              <tbody>
                <?php
                                                ...
                                                $table = mysqli_query($conn,'SELECT * FROM tbl_register WHERE status="Pending" ');
                ...
                <tr>
                  ...
                  <td class="text-center"><a href="" class="text-dark"><?php echo $row["companyname"]; ?></a></td>
                  <td class="text-center"><a href="" class="text-dark"><?php echo $row["type"]; ?></a></td>
                 
                  <td>
                    <ul class="d-flex justify-content-center text-center">
                      <button class="mr-3 btn btn-success deletebtn" ><i class="fas fa-check"></i> Approve</button>
                    </ul>
                  </td>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2014-2021 <a href="https://adminlte.io">RES-QUEUE</a>.</strong>
    All rights reserved.
    <div class="float-right d-none d-sm-inline-block">
      <b>Designed by</b> Group 8
    </div>
  </footer>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Approve Company Account</h5>
                ...
                <form action="code.php" method="POST">
                    <div class="modal-body">
                        <input type="hidden" name="app_id" id="delete_id">
                        <p>Are you sure to Approve this account?</p>
                        </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"data-dismiss="modal">Cancel</button>
                        <button type="submit" name="appdata" id="deletedata" class="btn btn-success">Approve</button>
                    </div>
                </form>
            </div>
        </div>
