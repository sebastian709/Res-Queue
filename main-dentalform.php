...
$query = "SELECT patienceno FROM dentalform ORDER BY patienceno DESC";
$result = mysqli_query($conn,$query);
$row = mysqli_fetch_array($result);
$lastid = $row['patienceno'];

if(empty($lastid))
{
    $number = "PN-".date("Ymd")."1";
}
else
{
    $idd = str_replace("PN-", "", $lastid);
...
{
    $inv = $_POST['patienceno'];
    $cname = $_POST['nofclinic'];
    $lname = $_POST['lname'];
    $fname = $_POST['fname'];
    $mname = $_POST['mname'];
    $sno = $_POST['age'];
    $transty = $_POST['dprocedures'];
    ...
    {
        $sql = "insert into dentalform(patienceno,nofclinic,lname,fname,mname,age,dprocedures)VALUES('".$inv."','".$cname."','".$lname."','".$fname."','".$mname."','".$sno."','".$transty."') ";
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col mt-4 mb-5">
        <h4 class="text-center mb-4">DENTAL CLINIC FORM</h4>
...
<?php
    ...
    <div class="row">
      <div class="col form-group">
        ...
        <input type="text" class="form-control text-info" name="patienceno" value="<?php echo $number; ?>" readonly>
      </div>
      <div class="col form-group">
        <label>Name of Clinic</label>
        <input type="text" class="form-control" name="nofclinic" value="<?php echo $row["companyname"];?>">
      </div>
      <?php
                                                    }
    ...
    <div class="row">
      ...
      <div class="col form-group">
        ...
        <input type="text" class="form-control" name="dprocedures">
      </div>
    </div>
    <div class="row">
