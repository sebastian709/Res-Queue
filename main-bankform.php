...
$query = "SELECT invno FROM bankform ORDER BY invno DESC";
...
{
    $inv = $_POST['invno'];
    $cname = $_POST['bankname'];
    $lname = $_POST['lname'];
    $fname = $_POST['fname'];
    $mname = $_POST['mname'];
    $sno = $_POST['accno'];
    $transty = $_POST['transaction'];
    ...
    {
        $sql = "insert into bankform(invno,bankname,lname,fname,mname,accno,transaction)VALUES('".$inv."','".$cname."','".$lname."','".$fname."','".$mname."','".$sno."','".$transty."') ";
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col mt-4 mb-5">
        <h4 class="text-center mb-4">BANK FORM</h4>
...
<?php
    ...
    <div class="row">
      <div class="col form-group">
        ...
        <input type="text" class="form-control" name="invno" value="<?php echo $number; ?>" readonly>
      </div>
      <div class="col form-group">
        <label>Bank Name</label>
        <input type="text" class="form-control" name="bankname" value="<?php echo $row["companyname"];?>">
      </div>
      <?php
                                                    }
